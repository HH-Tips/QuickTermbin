...
available_versions() {
    curl -s https://api.github.com/repos/HH-Tips/QuickTermbin/releases | grep '"tag_name"' | cut -d '"' -f 4
}
...
java -jar "$INSTALLATION_FOLDER/QuickTermbin.jar" "\$@"
EOF
...
URL="https://github.com/HH-Tips/QuickTermbin/releases/download/v${VERSION}/QuickTermbin.jar"
